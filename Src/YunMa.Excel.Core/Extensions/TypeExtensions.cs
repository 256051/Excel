...
namespace YunMa.Excel.Core.Extensions
{
    /// <summary>
...
//         /// <returns></returns>
//         public static IEnumerable<TFilter> GetFilter<TFilter>(this Type filterType, bool isDisableAllFilter) where TFilter : IFilter
//         {
//             IEnumerable<TFilter> filter = null;
//
//             if (isDisableAllFilter) return null;
// #if NETSTANDARD
//             //判断容器中是否已注册
//             if (AppDependencyResolver.HasInit)
//             {
//                 filter = AppDependencyResolver.Current.GetService<IEnumerable<TFilter>>();
//             }
