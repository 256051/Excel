...
namespace YunMa.Excel.Exporter.Base.Impl
{
    ...
    internal sealed class Export<T> : IExport<T> where T : class, new()
    {
        ...
        private readonly IEnumerable<IExporterHeaderFilter> _exporterHeaderFilters;

        /// <summary>
        /// 
        /// </summary>
        public Export(IEnumerable<IExporterHeaderFilter> exporterHeaderFilters, string sheetName = null)
        {
            ...
            _exporterHeaderFilters = exporterHeaderFilters;
        ...
        /// <param name="exporterHeaderFilters"></param>
        public Export(Type type, IEnumerable<IExporterHeaderFilter> exporterHeaderFilters)
        {
        ...
        public Export(ExcelPackage existExcelPackage, IEnumerable<IExporterHeaderFilter> exporterHeaderFilters, string sheetName = null)
        {
            ExcelPackage.LicenseContext = LicenseContext.NonCommercial;
        ...
        public ExcelExporterAttribute ExcelExporterSettings
        {
            get
            {
                ...
                _excelExporterAttribute = typeof(DataTable) == type
                    ? new ExcelExporterAttribute()
                    : type.GetAttribute<ExcelExporterAttribute>(true);
        ...
        /// 当前工作Sheet
        /// </summary>
        private ExcelWorksheet CurrentExcelWorksheet
        {
            get
            {
        ...
        /// 当前工作
        /// </summary>
        private List<ExcelWorksheet> ExcelWorksheets { get; set; } = new List<ExcelWorksheet>();
        ...
        /// 表头列表
        /// </summary>
        private List<ExporterHeaderInfo> ExporterHeaderList
        {
            get
            {
        ...
        /// 列头表达式
        /// </summary>
        private string ExporterHeadersString
        {
            get
            {
        ...
        /// Excel数据表
        /// </summary>
        private ExcelTable CurrentExcelTable { get; set; }

        /// <summary>
        /// 表头筛选器
        /// </summary>
        private IExporterHeaderFilter ExporterHeaderFilter { get; set; }

        /// <summary>
        /// 是否为动态DataTable导出
        /// </summary>
        private bool IsDynamicDatableExport { get; set; }

        /// <summary>
        /// 是否为ExpandoObject类型，调用LoadFromDictionaries以支持动态导出
        /// </summary>
        private bool IsExpandoObjectType { get; set; }

        /// <summary>
        /// 添加导出表头
        /// </summary>
        /// <param name="exporterHeaderInfos"></param>
        public void AddExporterHeaderInfoList(List<ExporterHeaderInfo> exporterHeaderInfos)
        {
        ...
        /// </summary>
        /// <returns></returns>
        private void GetExporterHeaderInfoList(DataTable dt = null, ICollection<T> dataItems = null)
        {
            ...
            else if (!IsDynamicDatableExport)
            {
                ...
                for (var i = 0; i < objProperties.Count; i++)
                {
                    ...
                    item.ExporterHeaderAttribute.IsIgnore =
                        (objProperties[i].GetAttribute<IgnoreAttribute>(true) == null)
                            ? item.ExporterHeaderAttribute.IsIgnore
                            : objProperties[i].GetAttribute<IgnoreAttribute>(true).IsExportIgnore;
        ...
        /// <returns></returns>
        private void AddExportHeaderInfo(ExporterHeaderInfo item)
        {
            //执行列头筛选器
        ...
        /// 设置列头筛选器
        /// </summary>
        public void SetExporterHeaderFilter(IExporterHeaderFilter exporterHeaderFilter)
        {
        ...
        /// </summary>
        /// <returns>文件</returns>
        public ExcelPackage ExportExcel(ICollection<T> dataItems)
        {
        ...
        /// </summary>
        /// <returns>文件</returns>
        public ExcelPackage ExportHeaders()
        {
            return AddHeaderAndStyles();
        }
        ...
        ///     导出Excel
        /// </summary>
        public ExcelPackage ExportExcel(DataTable dataItems)
        {
        ...
        private void AddDataItems(IEnumerable<ExpandoObject> dataItems, ExcelRangeBase excelRange = null)
        {
            if (excelRange == null)
        ...
        /// <param name="dataItems"></param>
        /// <param name="excelRange"></param>
        private void AddDataItems(IEnumerable<T> dataItems, ExcelRangeBase excelRange = null)
        {
            if (excelRange == null)
                excelRange = CurrentExcelWorksheet.Cells["A1"];
        ...
        private IEnumerable<ExpandoObject> ParseData(ICollection<T> dataItems)
        {
            var type = typeof(T);
        ...
        ///     添加图片
        /// </summary>
        private void AddPictures(int rowCount)
        {
            int ignoreCount = 0;
        ...
        private static void AddImage(int rowIndex, int colIndex, ExcelPicture picture, int yOffset, int xOffset)
        {
        ...
        /// <param name="excelRange"></param>
        private void AddDataItems(DataTable dataTable, ExcelRangeBase excelRange = null)
        {
            if (excelRange == null)
                excelRange = CurrentExcelWorksheet.Cells["A1"];
        ...
        /// 删除忽略列
        /// </summary>  
        private void DeleteIgnoreColumns()
        {
            var deletedCount = 0;
        ...
        // /// <returns></returns>
        // private IExporterHeaderFilter GetFilter(Type filterType = null)
        // {
        //     if (ExcelExporterSettings.IsDisableAllFilter)
        //     {
        //         return default;
        //     }
        //     return filterType != null ? _filters.FirstOrDefault(x => x.GetType() == filterType) : _filters.FirstOrDefault();
        // }
        ...
        private TFilter GetFilter<TFilter>(Type filterType = null) where TFilter : IFilter
        {
            ...
            var isImportHeaderFilter = filterType.GetInterfaces().Any(i => i == typeof(IExporterHeaderFilter));
            if (!isImportHeaderFilter) return default;
            var filter = _exporterHeaderFilters.FirstOrDefault(x => x.GetType() == filterType);
